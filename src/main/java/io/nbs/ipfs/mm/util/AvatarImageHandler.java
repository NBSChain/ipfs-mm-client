...
public class AvatarImageHandler {
    ...
    private static String AVATAR_ROOT_PATH;
    ...
    public void initAvatarLocalDir(){
         ...
         */
        destFile = new File(DappCnsts.consturactPath(AVATAR_PROFILE_HOME,"thumbs"));
    ...
    public ImageIcon getAvatar128(String hashFileName){
        ...
        File iconFile = new File(DappCnsts.consturactPath());
        if(!iconFile.exists())return IconUtil.getIcon(this,"/icons/nbs128.png");
        ImageIcon icon = new ImageIcon(DappCnsts.consturactPath(AVATAR_PROFILE_HOME,hashFileName));
        return icon;
    }
    ...
    public ImageIcon createContactsAvatar(File srcFile,String hashFileName){
        ...
        String targetPath = DappCnsts.consturactPath(AVATAR_CUSTOM_HOME,hashFileName);
    ...
    public ImageIcon getAvatarScaleIcon(File srcFile,int size){
        ...
        try {
            ...
            ImageIcon newIcon = new ImageIcon(DappCnsts.consturactPath(AVATAR_CUSTOM_HOME,"f"+size,fineName));
