package io.nbs.ipfs.mm.ui.components;
...
public class LamButtonIcon extends JLabel {
    ...
    public LamButtonIcon(String normal, String active, String tip) {
        ImageIcon norIcon = new ImageIcon(DappCnsts.TOOL_ICON_PATH + normal);
        ImageIcon axtIcon =  new ImageIcon(DappCnsts.TOOL_ICON_PATH+active);
