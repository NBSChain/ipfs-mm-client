...
public class AboutHeaderPanel extends ParentAvailablePanel {
    ...
    private void initView() {
        ...
        String title = Launcher.LaucherConfMapUtil.getValue("nbs.ui.panel.about.label.version-title","The Next Block chain System");
        titleLabel.setText(title);
        titleLabel.setFont(FontUtil.getDefaultFont(32));
        titleLabel.setForeground(ColorCnst.FONT_ABOUT_TITLE_BLUE);
        String verText =  Launcher.LaucherConfMapUtil.getValue("nbs.ui.panel.about.label.ver-value","v2.0.2");
