package io.nbs.ipfs.mm.ui.panels.im.adapters;

import io.nbs.ipfs.mm.Launcher;
import io.nbs.ipfs.mm.ui.adapter.BaseAdapter;
import io.nbs.ipfs.mm.ui.adapter.MessageMouseListener;
...
import io.nbs.ipfs.mm.ui.panels.im.cache.MessageViewHolderCacheHelper;
import io.nbs.ipfs.mm.ui.panels.im.messages.MessageLeftTextViewHolder;
import io.nbs.ipfs.mm.ui.panels.im.messages.MessageRightTextViewHolder;
import io.nbs.ipfs.mm.ui.panels.im.messages.MessageSystemMessageViewHolder;
import io.nbs.ipfs.mm.ui.panels.im.messages.RightAttachmentMessageViewHolder;
import io.nbs.ipfs.mm.util.AvatarUtil;
import io.nbs.ipfs.mm.util.TimeUtil;
...
public class MessageAdapter extends BaseAdapter<BaseMessageViewHolder> {
     ...
     * 消息数组
     */
    private java.util.List<MessageItem> messageItems;
     ...
     */
    public MessageAdapter(java.util.List<MessageItem> messageItems, NbsListView listView, MessageViewHolderCacheHelper messageViewHolderCacheHelper) {
        this.currentPeer = Launcher.getContext().getCurrentPeer();
