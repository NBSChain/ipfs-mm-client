...
import io.nbs.ipfs.mm.ui.panels.im.ChatPanel;
import io.nbs.ipfs.mm.util.ClipboardUtil;
...
public class ScreenShot extends JFrame {
    ...
    private void initControlDialog()
    {
        ...
        JLabel okLabel = new JLabel(IconUtil.getIcon(this, "/icon/im/ok.png"));
        JLabel cancelLabel = new JLabel(IconUtil.getIcon(this, "/icon/im/cancel.png"));
        JLabel downloadLabel = new JLabel(IconUtil.getIcon(this, "/icon/im/download.png"));
        ...
        downloadLabel.addMouseListener(new MouseAdapter()
        {
            ...
            {
                downloadLabel.setIcon(IconUtil.getIcon(this, "/icon/zh_cn/download_active.png"));
            ...
            {
                downloadLabel.setIcon(IconUtil.getIcon(this, "/icon/zh_cn/download.png"));
                super.mouseExited(e);
            }
        });
        ...
        okLabel.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseEntered(MouseEvent e)
            {
                okLabel.setIcon(IconUtil.getIcon(this, "/icon/zh_cn/ok_active.png"));
                super.mouseEntered(e);
            }
            ...
            public void mouseExited(MouseEvent e)
            {
                okLabel.setIcon(IconUtil.getIcon(this, "/icon/zh_cn/ok.png"));
                super.mouseExited(e);
            }
        });
        cancelLabel.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseEntered(MouseEvent e)
            {
                cancelLabel.setIcon(IconUtil.getIcon(this, "/icon/zh_cn/cancel_active.png"));
                super.mouseEntered(e);
            }
            ...
            public void mouseExited(MouseEvent e)
            {
                cancelLabel.setIcon(IconUtil.getIcon(this, "/icon/zh_cn/cancel.png"));
                super.mouseExited(e);
            }
        });
