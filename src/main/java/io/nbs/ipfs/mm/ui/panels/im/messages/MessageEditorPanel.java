...
import io.nbs.ipfs.biz.listeners.IPFSFileUploader;
import io.nbs.ipfs.mm.Launcher;
import io.nbs.ipfs.mm.cnsts.ColorCnst;
import io.nbs.ipfs.mm.cnsts.DappCnsts;
import io.nbs.ipfs.mm.ui.components.*;
import io.nbs.ipfs.mm.ui.frames.ScreenShot;
import io.nbs.ipfs.mm.ui.panels.ParentAvailablePanel;
import io.nbs.ipfs.mm.ui.panels.im.IMFileActionListener;
...
/*        JIntellitype.getInstance().registerHotKey(SEREEN_SHOT_CODE,JIntellitype.MOD_ALT,'$');
    ...
    private void initComponents(){
         ...
         * 图标
         */
        String buttonIconRoot = DappCnsts.IM_ICON_ROOT;


        emojiIcon = new NBSIcon(
                Launcher.class.getResource(buttonIconRoot+"emotion.png"),
                Launcher.class.getResource(buttonIconRoot+"emotion_active.png"),
                "表情");
        expressionLabel.setIcon(emojiIcon);
        //expressionLabel.add(emojiIcon);

        fileIcon = new NBSIconButton(
                new ImageIcon(Launcher.class.getResource(buttonIconRoot+"file.png")),
                new ImageIcon(Launcher.class.getResource(buttonIconRoot+"file_active.png")),
                "发送文件/图片"
        );
        ...
        cutIcon = new NBSIconButton(
                new ImageIcon(Launcher.class.getResource(buttonIconRoot+"cut.png")),
                new ImageIcon(Launcher.class.getResource(buttonIconRoot+"cut_active.png")),
                cutTip
        );
