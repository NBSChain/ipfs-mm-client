...
public class PeerServiceImpl {
    ...
    private ContactsItem constructionItemByPeerId(String peerId){
        ...
        String nickTemp = peerId.substring(2,6)+ DappCnsts.NOTNBS_PEER_MIDDLE + peerId.substring(peerId.length()-4);
    ...
    public List<String> getOnlinePeers(){
        ...
        try {
            Object o = null;
            if(Launcher.LaucherConfMapUtil.subWorldPeers()){
